...
<div class="py-4">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    <h1 class="h4">Data Products</h1>
                    <p class="mb-0">List data seluruh Products</p>
                </div>
                <div>
                    <a href="{{ route('products.create') }}" class="btn btn-success text-white"><i
                            class="far fa-question-circle me-1"></i> Tambah Products</a>
                </div>
            </div>
        </div>
